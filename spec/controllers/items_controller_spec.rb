...
describe ItemsController do
  ...
  let(:current_user_account) { Account.create(login:'login', user: subject.current_user)  }
  let(:other_user_account) { Account.create(login:'other login', user: build(:user))  }
  ...
  describe "GET index" do
    ...
    it "displays items for current user" do
      current_item = Item.create! valid_attributes
      other_item = Item.create! valid_attributes.merge(account: other_user_account)
      get :index, {}, valid_session
      assigns(:items).should eq([current_item])
    end
  end
